...
const TICKETS: TicketItem[] = [
  {
    ...
    price: "€39",
    image:
      "https://images.unsplash.com/photo-1483412033650-1015ddeb83d1?q=80&w=2370&auto=format&fit=crop&ixlib=rb-4.1.0",
  ...
  },
  {
    ...
    price: "€29",
    image:
      "https://images.unsplash.com/photo-1516570161787-2fd917215a3d?q=80&w=2370&auto=format&fit=crop&ixlib=rb-4.1.0",
  ...
  },
  {
    ...
    price: "€34",
    image:
      "https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?q=80&w=2370&auto=format&fit=crop&ixlib=rb-4.1.0",
      ...
      <div className="bg-background relative size-full overflow-hidden rounded-2xl">
        ...
        <div className="absolute inset-0 z-20 grid content-between rounded-2xl bg-black/30 backdrop-blur-sm p-5 text-zinc-100">
          ...
          <div className="flex items-center justify-between pt-3">
            ...
            <Button
              size="sm"
              className="rounded-full hover:cursor-pointer hover:bg-zinc-800"
            >
              Buy Ticket
            </Button>
          </div>
